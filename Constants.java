...
public class Constants {
	...
	// Time properties
	public static final double tmax = 3.; // Max time to solve for
	public static final int tsteps = 30000; // Number of steps to take
	...
	public static final int record_frequency = 300; // Number of timesteps between recording data
